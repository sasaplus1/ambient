...
const DICTIONARY = {
  ...
  'background.kind': { ja: '種類', en: 'Type' },
  'background.gradient': { ja: 'グラデーション', en: 'Gradient' },
  'backgroundKind.none': { ja: 'なし', en: 'None' },
  'backgroundKind.gradient': { ja: 'グラデーション', en: 'Gradient' },
  'backgroundKind.image': { ja: '画像', en: 'Image' },
